...
describe('_c', function() {
  ...
  before(function() {
    return fs.mkdirs(baseDir).then(function() {
      ...
      return fs.writeFile(enFile.source, new Buffer('description: English description')).then(function() {
        return process(enFile);
      }).then(function() {
        return fs.writeFile(esFile.source, new Buffer('description: Descripción en español')).then(function() {
